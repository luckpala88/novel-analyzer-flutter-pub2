...
class _AdaptPageState extends State<AdaptPage>
  ...
  Future<void> _updateStoryBible(
    ...
    try {
      ...
      final result = await state.api.callApi(
        systemPrompt: existed
            ? PromptBuilder.buildBibleUpdateSystemPrompt()
            : PromptBuilder.buildBibleInitSystemPrompt(),
        userPrompt: existed
            ? PromptBuilder.buildBibleUpdateUserPrompt(
                bible: wb.adaptBible,
                arcNumber: arcNumber.toString(),
                declaration: declaration,
                arcEntry: arcEntry,
              )
            : PromptBuilder.buildBibleInitUserPrompt(
