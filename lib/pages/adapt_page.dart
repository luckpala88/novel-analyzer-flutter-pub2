            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (layer == 0) const SizedBox(height: 6),
                  // 生成按钮+声明按钮
                  Row(
                    children: [
                      if (layer == 0)
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // v584：每场景独立改编要求（场景页布局对齐弧线页：概述→要求→按键→声明）
                            _CollapseReqField(
                              controller: TextEditingController(
                                  text: sceneReq),
                              labelText:
                                  '场景${bi + 1}改编要求（可选，与弧线/全局要求综合生效）',
                              fontSize: 11.5,
                              expandLines: 4,
                              onChanged: (v) {
                                if (state.worldBook == null)
                                  state.worldBook = WorldBook();
                                state.worldBook!
                                    .sceneRequirements[sceneReqKey] = v;
                                state.saveWorldBook();
                              },
                            ),
                            Row(
